# Sample roster for a practice run

`pby-sample-roster.xlsx` (and the same data as `.csv`) is a fake 30-party roster for trying the
app end to end: families, seniors, teams of 12–16, couples, and one walk-in with no phone.

- Columns match the app's import template: **Name, Phone, Party Size, Members, Group, Notes**.
